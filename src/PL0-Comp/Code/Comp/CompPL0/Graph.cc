...
Graph::Graph()
{
    ...
    /* 2*/ Trans(Trans::Token,      (void*)Token::Identifier,  3,  0, ILGen::AddSymbol),      /*(B)----ident--->(C)*/
    /* 3*/ Trans(Trans::Symbol,     "=",                       4,  0, nullptr),               /*(C)-----'='-----(D)*/
    /* 4*/ Trans(Trans::Token,      (void*)Token::Number,      5,  0, ILGen::AddConstant),    /*(D)--->number-->(E)*/
    ...
    /* 9*/ Trans(Trans::Token,      (void*)Token::Identifier, 10,  0, ILGen::AddSymbol),      /*(G)----ident--->(H)*/
    ...
    /*14*/ Trans(Trans::Token,      (void*)Token::Identifier, 15,  0, ILGen::AddSymbol),      /*(J)----ident--->(K)*/
    ...
    m_statement =
    {
    /* 0*/ Trans(Trans::Token,      (void*)Token::Identifier,  1,  3, ILGen::BeforeAssignment), /*(A)----ident--->(B)*/
    ...
    /*16*/ Trans(Trans::Token,      (void*)Token::Identifier, 25,  0, ILGen::CallProcedure),    /*(L)----ident--->(Q)*/
    /*17*/ Trans(Trans::Symbol,     "?",                      18, 19, nullptr),                 /* +------'?'-----(M)*/
    /*18*/ Trans(Trans::Token,      (void*)Token::Identifier, 25,  0, ILGen::InputNumber),      /*(M)----ident--->(Q)*/
    /*19*/ Trans(Trans::Symbol,     "!",                      20, 24, nullptr),                 /* +------'!'-----(N)*/
    /*20*/ Trans(Trans::Symbol,     "\"",                     21, 23, nullptr),                 /*(N)-----'"'---->(O)*/
    /*21*/ Trans(Trans::Token,      (void*)Token::String,     22,  0, ILGen::OutputString),     /*(O)---string--->(P)*/
    ...
    m_factor =
    {
    /* 0*/ Trans(Trans::Token,      (void*)Token::Number,     5, 1, ILGen::ConstByVal),  /*(A)---number--->(D)*/
    ...
    /* 4*/ Trans(Trans::Token,      (void*)Token::Identifier, 5, 0, ILGen::IdentByName), /* +----ident---->(D)*/
